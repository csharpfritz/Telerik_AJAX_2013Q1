<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test1.aspx.cs" Inherits="Demo._1_DropDownList.test1" %>
...
<body>
    ...
    <div>
      ...
      <telerik:RadDropDownList runat="server" ID="ddProducts" Width="300px" DropDownWidth="300px" DropDownHeight="300px" DataSourceID="games" DataTextField="Name" DataValueField="ID">
