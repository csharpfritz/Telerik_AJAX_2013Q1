...
{
    /// <summary>
    /// Web API Controller for Products entity defined in Demo.gamesModel data model
    /// </summary>
    public partial class ProductsController : OpenAccessBaseApiController<Demo.Product, Demo.gamesModel>
    {
        /// <summary>
        ...
        public ProductsController(IOpenAccessBaseRepository<Demo.Product , Demo.gamesModel> repository)
        {
        ...
        public virtual Demo.Product Get(Int32 id)
        {
            Demo.Product entity = repository.GetBy(d => d.ID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, Demo.Product entity)
        {
                        if (entity == null ||
                id != entity.ID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, Demo.Product entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<Demo.Product>(httpStatusCode, entityToEmbed);
