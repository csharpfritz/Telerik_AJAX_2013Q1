<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webinar.aspx.cs" Inherits="Demo._4_PivotGrid.webinar" %>
...
<body>
    ...
    <div>
      ...
      <telerik:RadPivotGrid runat="server" ID="grid" DataSourceID="sales" AllowPaging="true" AllowFiltering="true" EnableConfigurationPanel="true">
